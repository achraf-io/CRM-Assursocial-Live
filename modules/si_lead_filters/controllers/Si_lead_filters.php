...
class Si_lead_filters extends AdminController 
{
	...
	public function leads_filter()
	{
		...
		$data['staff_1'] = $this->si_lead_filter_model->get_member('', ['equipe' => "Equipe IARD Sylvia"]);
        
        $data['staff_2'] = $this->si_lead_filter_model->get_member('', ['equipe' => "Equipe Santé Marina"]);
		$data['staff_resp'] = $this->si_lead_filter_model->get_member('', ['role' => 1]);
