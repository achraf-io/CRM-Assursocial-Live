						...
						<div class="row">
							<?php if(has_permission('leads','','view')){ ?>
								...
								<?php if ($current_id == 17) {
									  ...
									  if ($current_id == 17) {
										$selected =  $current_id;
									echo render_select('member',$staff_1,array('staffid',array('firstname','lastname')),'',$selected,array('data-none-selected-text'=>_l('all_staff_members')),array(),'no-margin','',false); 
									}
									} elseif ($current_id == 26) {
										$selected = '';
									  if ($current_id == 26	) {
										$selected =  $current_id;
										echo render_select('member',$staff_2,array('staffid',array('firstname','lastname')),'',$selected,array('data-none-selected-text'=>_l('all_staff_members')),array(),'no-margin','',false);
									}
									} elseif ($current_id == 1) {
										echo render_select('member',$staff_resp,array('staffid',array('firstname','lastname')),'','',array('data-none-selected-text'=>_l('all_staff_members')),array(),'no-margin');
									}
									?>
