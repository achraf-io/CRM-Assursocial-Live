        ...
        <div class="row">
            <div class="col-md-7">
                <div class="panel_s">
                  ...
                  <div class="form-group">
                    <label for="facebook" class="control-label"> <?php echo _l('EQUIPE'); ?></label>
                    <input type="text" class="form-control" name="equipe" value="<?php if(isset($member)){echo $member->equipe;} ?>">
                </div>
