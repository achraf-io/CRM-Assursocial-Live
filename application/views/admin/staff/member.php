            ...
            <div class="panel-body">
               ...
               <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                     ...
                     <div class="form-group select-placeholder">
                        <label for="direction"><?php //echo _l('document_direction'); ?>Equipe</label>
                        <select class="form-control selectpicker"  data-width="100%" name="equipe" id="equipe">
                           <?php foreach($user as $equipe):
                            $selected = '';
                                 if(isset($member)){
                                    if($member -> equipe_id == NULL){
                                       $selected = 'selected';
                                    }
                                 
                                } 
                              ?>
                              <option value="<?php echo $equipe->Equipe_name; ?>" <?php echo $selected; ?>><?php echo  $equipe->Equipe_name; ?></option>
                              <?php endforeach;?>
