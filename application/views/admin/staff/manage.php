			...
			<div class="col-md-12">
				...
				<div class="panel_s">
					<div class="panel-body">
						...
						if ($id == 17 || $equipeid ->equipe == "Equipe IARD Sylvia") { ?>
							<div class="_buttons">
								<a href="<?php echo  htmlspecialchars(admin_url("staff/path/1")); ?>" class="btn btn-info pull-left display-block">Afficher mon équipe</a>
							</div>
						<?php } elseif ($id == 26 || $equipeid ->equipe == "Equipe Santé Marina") { ?>
							<div class="_buttons">
								<a href="<?php echo  htmlspecialchars(admin_url("staff/path/2")); ?>" class="btn btn-info pull-left display-block">Afficher mon équipe </a>
