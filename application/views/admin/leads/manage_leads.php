                                    ...
                                    <?php if ($current_id == 17) {
                                        ...
                                        if ($current_id == 17) {
                                          $selected =  $current_id;
                                                ...
                                                if ($current_id == 26) {
                                                  $selected =  $current_id;
                                                echo  render_select('view_assigned', $staff_2, array('staffid', array('firstname', 'lastname')), '', $selected , array('data-width' => '100%', 'data-none-selected-text' => _l('leads_dt_assigned')), array(), 'no-mbot','',false);
                                             }
                                             } elseif ($current_id == 1) {
                                                echo  render_select('view_assigned', $staff_resp, array('staffid', array('firstname', 'lastname')), '', '', array('data-width' => '100%', 'data-none-selected-text' => _l('leads_dt_assigned')), array(), 'no-mbot');
                                             }
                                         ?>
                                    </div>
                                 <?php } ?>
                                    ...
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-body">
                                          ...
                                          <div id="bulk_change">
                                             ...
                                             if ($current_id == 17) {
                                                echo render_select('assign_to_leads_bulk', $staff_1, array('staffid', array('firstname', 'lastname')), 'leads_dt_assigned');
                                             } elseif ($current_id == 26) {
                                                echo render_select('assign_to_leads_bulk', $staff_2, array('staffid', array('firstname', 'lastname')), 'leads_dt_assigned');
                                             } elseif ($current_id == 1) {
                                                echo render_select('assign_to_leads_bulk', $staff_resp, array('staffid', array('firstname', 'lastname')), 'leads_dt_assigned');
                                             }
                                             ?>
                                             <div class="form-group">
