         ...
         <div class="col-md-6">
           ...
           <!--<?php //if((isset($lead) && empty($lead->website)) || !isset($lead)){
              ...
              //} else { ?>
               ...
               <label for="website"><?php  //echo _l('lead_website'); ?>Services</label>
            ...
            <!--<div class="form-group">
                <label for="lead_value"><?php //echo _l('lead_value'); ?>Services</label>
                <div class="input-group" data-toggle="tooltip" title="<?php //echo _l('lead_value_tooltip'); ?>">
                    <input type="text" class="form-control" name="lead_value" value="<?php// if(isset($lead)){echo $lead->lead_value; }?>">
                    <div class="input-group-addon">
