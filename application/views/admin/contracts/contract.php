               ...
               <div class="panel-body">
                  ...
                  ?>
                     <div class="form-group select-placeholder">
                        <label for="direction"><?php  
                                                ?>Type de contrat</label>
                        <select class="form-control selectpicker" data-width="100%" name="contract_type" //id="contract_type">
                           <?php foreach ($car as $contrats) :
                                $selected = (isset($contract) ? $contract->contract_type : '');
                                             
                           ?>
                              <option value="<?php echo $contrats->id; ?>" <?php echo $selected; ?>><?php echo  $contrats->name; ?></option>
                           <?php endforeach; ?>
                        </select>
                     </div>
                  <?php } elseif ($role['role'] == 1) { ?>
                     ...
                     <div class="form-group select-placeholder">
                        <label for="direction"><?php 
                                                ?>Type de contrat</label>
                        <select class="form-control selectpicker" data-width="100%" name="contract_type" >
                           <?php foreach ($cae as $contrats) :
                              $selected = (isset($contract) ? $contract->contract_type : '');
                  ...
                  <?php  } elseif ($role['role'] == 4) { ?>
                     <div class="form-group select-placeholder">
                        <label for="direction"><?php  
                                                ?>Type de contrat</label>
                        <select class="form-control selectpicker" data-width="100%" name="contract_type" >
                           <?php foreach ($gestion as $contrats) :
                              $selected = (isset($contract) ? $contract->contract_type : '');
