...
class Contracts extends AdminController
{
    ...
    public function contract($id = '')
    {
        ...
        $this->load->model('contract_types_model' , 'contract_types');
        $data['car'] = $this->contract_types->typeCar();
        $data['cae'] = $this->contract_types->typeCae();
        $data['gestion'] = $this->contract_types->type_gestionnaire();
        $current_id = get_staff_user_id();
        $data['current_id']    = $current_id;
        $data['role']          = $this->staff->getStaff_role($current_id);
        $data['base_currency'] = $this->currencies_model->get_base_currency();
